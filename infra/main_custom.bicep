// ============================================================================
// main_custom.bicep — Orchestrator for Local Code Deployment
// Description: Pure orchestrator for Customer Chatbot Solution Accelerator
//              Deploys infrastructure for azd-based local code deployment
//              All resource names are derived from params — no hardcoded names.
//              Mode: Non-WAF (vanilla Bicep) with local code deployment
// ============================================================================
...
module log_analytics './bicep/modules/monitoring/log-analytics.bicep' = if (enableMonitoring && !useExistingLogAnalytics) {
...
module app_insights './bicep/modules/monitoring/app-insights.bicep' = if (enableMonitoring) {
...
module ai_foundry_project './bicep/modules/ai/ai-foundry-project.bicep' = if (!useExistingAIProject) {
...
module ai_search './bicep/modules/ai/ai-search.bicep' = {
...
module foundry_search_connection './bicep/modules/ai/ai-foundry-connection.bicep' = {
...
module hostingplan './bicep/modules/compute/app-service-plan.bicep' = {
