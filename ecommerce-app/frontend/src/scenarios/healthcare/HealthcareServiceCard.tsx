...
import { resolveHealthcareServiceMeta } from '@/scenarios/healthcare/healthcareServiceMeta';

interface HealthcareServiceCardProps {
  product: Product;
}

export const HealthcareServiceCard = memo(({ product }: HealthcareServiceCardProps) => {
  const meta = resolveHealthcareServiceMeta(product);
