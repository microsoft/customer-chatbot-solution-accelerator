...
param imageName string = 'frontend'
...
param tags object = {
  ...
  Application: 'E-commerce Chat Frontend Container'
  ManagedBy: 'Bicep'
}
...
var containerImage = '${acrLoginServer}/${imageName}:${imageTag}'

// Frontend App Service with Container
